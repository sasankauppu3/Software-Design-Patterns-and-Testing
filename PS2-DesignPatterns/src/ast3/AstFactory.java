...
public class AstFactory extends AstAbstractFactory{
	...
	/**
	 * report writes a list of counts of instances of Node created with AstFactory object to logger
	 */
	public void report()
	{
		...
		logoutput.log(Level.SEVERE, outputText,new Object[]{numberExpressionCount,stringExpressionCount, variableExpressionCount,prefixExpressionCount,infixExpressionCount,sequenceExpressionCount,assignmentExpressionCount,declarationExpressionCount});
	}
	
	/**
	 * getReport returns list of counts of instances of Node created with AstFactory object

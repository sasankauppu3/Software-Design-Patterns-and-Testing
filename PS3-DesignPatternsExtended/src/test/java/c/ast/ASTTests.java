...
public class ASTTests {
	 ...
	 * and var y; y = hello;" and checking Node's getId and getNode methods
	 */
	public void test1(){
		...
		assertEquals(2,exp1.getId());
		assertEquals(3,exp3.getId());
		assertEquals(4,st1.getId());
		assertEquals(5,st3.getId());
		assertEquals(6,st2.getId());
		assertEquals(7,st5.getId());
		assertEquals(8,seq1.getId());
		assertEquals(9,seq3.getId());
	}

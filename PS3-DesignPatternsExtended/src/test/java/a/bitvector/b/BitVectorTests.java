...
public class BitVectorTests {
	...
	@Test
	/**
	 * Testing for testing the iterator in BitVector
	 */
	public void test6() {
		BitVector a = new BitVector();
		...
		assertEquals(true, aIterator.hasAnotherElement());
		assertEquals((Integer)0, aIterator.nextElement());
		assertEquals(false, aIterator.hasAnotherElement());
	}
